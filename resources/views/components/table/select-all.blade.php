    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p id="bulkActionMessage">Are you sure you want to perform this action on <span id="bulkActionCount">0</span> selected items?</p>
                
                <div id="bulkDownloadOptions" style="display: none;">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="downloadFormat" id="formatExcel" value="excel">
